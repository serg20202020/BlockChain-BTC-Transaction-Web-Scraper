...
count = 0
while count < 5:
    data = data + webScraper()
    #print(count)
    count += 1

    #Wait 60 seconds before running the function again  //if there are a lot of transactions it might be worth setting it to 30 seconds and change the while to count < 10
    time.sleep(60)
...
print("\n")
print("Top 10 BTC transactions in the last 5 minutes")
print("\n")
